...
srclink_project = 'https://github.com/is-this-valid/liberty'
...
version = "0.0.1"  # liberty.__version__
# The full version, including alpha/beta/rc tags.
release = version  # liberty.__version__
...
html_title = "Liberty Documentation"
...
html_sidebars = {
    '*': sidebars_localtoc,
    # 'liberty/index': sidebars_localtoc,
}
...
html_use_opensearch = 'https://is-this-valid.github.io/liberty/'
...
latex_documents = [
    ('index', 'liberty.tex', u'Liberty Documentation',
     u'Liberty', 'manual'),
]
...
man_pages = [
    ('index', 'liberty', u'Liberty Documentation',
     [u'Liberty'], 1)
]
...
texinfo_documents = [
    ('index', 'liberty', u'Liberty Documentation',
     u'Liberty', 'liberty', 'Liberty Documentation',
     'Liberty'),
]
...
def configure_meta_tags(app, pagename, templatename, context, doctree):
    ...
    """.format(
        ...
        og_site_name="Liberty",
        og_image_url="https://is-this-valid.github.io/liberty/static/png/",
        og_image_width="480",
        og_image_height="240",
        twitter_user="")
